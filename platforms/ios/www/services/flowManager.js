happyLeaf.factory('flowManager', ['$rootScope', '$localStorage', 'logManager', 'connectionManager', '$translate', function($rootScope, $localStorage, logManager, connectionManager, $translate){
  var self = {
    ...
    requestDriving: function(finished){
      ...
      self.commands.getOdometer = 6;
      self.commands.getHeadlights.priority = 15;
      self.commands.getAll.priority = 10;
    ...
    requestMessages: function(desiredRequest, finished){
      var atmaCommands = [self.commands.getSpeed, self.getOdometer, self.commands.getSOH, self.commands.getHeadlights, self.commands.getAll, self.getTires];
    ...
    commands: {
      ...
      getMotorWatts: {
        codes: ["ATCM7FE", "ATCF180", "ATMA", "X", "ATCM7FE", "ATCF176", "ATMA", "X", "X"],
        priority: 2,
        speed: 10,
        lastSent: null,
