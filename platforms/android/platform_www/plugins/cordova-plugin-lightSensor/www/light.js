cordova.define("cordova-plugin-lightSensor.light", function(require, exports, module) {
/*
 *
...
var light = {
     ...
     */
    getLightState: function(successCallback) {
        argscheck.checkArgs('F', 'light.getLightState', arguments);
        exec(successCallback, null, "Light", "getLightState", []);
    },
